  ...
  return (
    ...
    <div className="">
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <input type="text" id="first_name" className="w-96 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-4" placeholder="Todo item" required value={input} onChange={handleInputChange}/>
